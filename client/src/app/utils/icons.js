...
export function ArrowUp({ fill }) {
  return (
    <svg
      ...
      height="1.6em"
      viewBox="0 0 24 24"
      className={fill ? "fill-black" : "fill-neutral-400"}
    >
      <path d="m11 8.8l-2.9 2.9q-.275.275-.7.275t-.7-.275q-.275-.275-.275-.7t.275-.7l4.6-4.6q.3-.3.7-.3t.7.3l4.6 4.6q.275.275.275.7t-.275.7q-.275.275-.7.275t-.7-.275L13 8.8V17q0 .425-.288.713T12 18q-.425 0-.713-.288T11 17V8.8Z"></path>
    </svg>
  );
}

export function ArrowDown({ fill }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1.6em"
      ...
      className={fill ? "fill-black" : "fill-neutral-400"}
    >
      <path d="M11 14.175V7q0-.425.288-.713T12 6q.425 0 .713.288T13 7v7.175l2.9-2.875q.275-.275.688-.288t.712.288q.275.275.275.7t-.275.7l-4.6 4.6q-.3.3-.7.3t-.7-.3l-4.6-4.6q-.275-.275-.288-.687T6.7 11.3q.275-.275.7-.275t.7.275l2.9 2.875Z"></path>
    </svg>
  );
}
