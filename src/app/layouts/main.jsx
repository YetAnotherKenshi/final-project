...
import { Headphones, Keyboard, Monitor, Mouse } from '../utils/icons';
	...
	return (
		<div className="z-0">
			...
			<div className="grid grid-cols-5 gap-6 mt-4">
				...
				<button
					className="bg-gradient-to-tr from-blue-300 to-blue-400 h-48 rounded flex flex-col items-center justify-center"
					onClick={() => history.push('/shop/monitor')}
				>
					<Monitor />
					<p className="text-white text-2xl font-semibold mt-2">Мониторы</p>
				</button>
				<button
					className="bg-gradient-to-tr from-purple-400 to-purple-500 h-48 rounded-md flex flex-col items-center justify-center"
					onClick={() => history.push('/shop/headphones')}
